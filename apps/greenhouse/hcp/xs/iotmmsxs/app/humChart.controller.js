sap.ui.controller("app.humChart", {
    /**
    ...
    */
    onInit: function(oEvent) {
        ...
        oModel.loadData("services/iotservices.xsjs", null, false);
        ...
        /************************************************/
        var grid = this.getView().byId("GeneralInfoHumidity");
        grid.setModel(this._getGridModel(data));

        /************************************************/
        var oVizFrame = this.getView().byId("idVizFrameLineHumidity");
        ...
        var oPopOver = this.getView().byId("idPopOverHumidity");
        oPopOver.connect(oVizFrame.getVizUid());

        /************************************************/
        var oVizFrameAverageTemperatureByDay = this.getView().byId("idVizFrameColumnAverageHumidityByDay");
        ...
        var oPopOverAverageTemperatureByDay = this.getView().byId("idPopAverageHumidityByDay");
        oPopOverAverageTemperatureByDay.connect(oVizFrameAverageTemperatureByDay.getVizUid());

        /************************************************/
        var oVizFrameTemperatureMinMax = this.getView().byId("idVizFrameColumnHumidityMinMax");
        ...
        var oPopOverTemperatureMinMax = this.getView().byId("idPopOverHumidityMinMax");
    ...
    _createAvgByDayData: function(obj) {
        ...
        _.each(groupByDay, function(value, key, list){
            var result = {};
            result.day = key;
            result.average = _.mean(_.map(value, function(i) { return parseFloat(i.humidity); })).toFixed(1);
